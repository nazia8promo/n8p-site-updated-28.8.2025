  ...
  return (
    <section className="storyboard-shell home-motion-zone overflow-hidden p-5 lg:p-7">
      <div className="grid gap-6 lg:grid-cols-[0.88fr_1.12fr] lg:items-start">
        ...
        <div className="storyboard-stage relative z-10 aspect-[16/9] rounded-[1.85rem] p-4 text-white ring-1 ring-white/10 lg:p-5">
          <div className="grid h-full gap-3 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="space-y-3 rounded-[1.4rem] bg-white/6 p-4 ring-1 ring-white/10">
            ...
            <div className="grid gap-3">
              <div className="rounded-[1.4rem] bg-[#1E4FD1]/22 p-4 ring-1 ring-[#2D66F6]/22">
              ...
              <div className="rounded-[1.4rem] bg-[#C88A35]/18 p-4 ring-1 ring-[#C88A35]/24">
              ...
              <div className="rounded-[1.4rem] bg-[#10B981]/14 p-4 ring-1 ring-[#10B981]/18">
